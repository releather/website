...
const beforeAfterItems: LeatherRestorationBeforeAfterItem[] = [
  {
    ...
    color: <a href="https://res.cloudinary.com/releather-com/image/upload/v1639529981/leather/Luxor_Espresso_HI.jpg" title="Espresso leather swatch - custom color change option" target="_blank" rel="noopener noreferrer">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://res.cloudinary.com/releather-com/image/upload/c_crop,w_250,h_50/bo_2px_solid_rgb:f8991d/v1639529981/leather/Luxor_Espresso_HI.jpg" alt="Espresso leather swatch for custom color change" title="Espresso leather swatch - custom color change option" width={250} height={50} loading="lazy" /></a>,
  ...
  },
  {
    ...
    color: <a href="https://res.cloudinary.com/releather-com/image/upload/v1639529981/leather/Concerto_Saddle_HI.jpg" target="_blank" rel="noopener noreferrer">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://res.cloudinary.com/releather-com/image/upload/c_crop,w_250,h_50/bo_2px_solid_rgb:f8991d/v1639529981/leather/Concerto_Saddle_HI.jpg" alt="Concerto Saddle Leather Sample" title="Concerto Saddle Leather Sample" width={250} height={50} loading="lazy" /></a>,
  ...
  },
  {
    ...
    color: <a href="https://res.cloudinary.com/leathera/image/upload/b_rgb:000000/l_text:montserrat_80_style_light:Mushroom,co_rgb:ffffff/leather/Metallic/Metallic_Leather_Mushroom.jpg" target="_blank" rel="noopener noreferrer">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://res.cloudinary.com/leathera/image/upload/c_crop,w_250,h_50/bo_2px_solid_rgb:f8991d/leather/Metallic/Metallic_Leather_Mushroom.jpg" alt="Metallic Mushroom leather swatch used for restoration" title="Metallic Mushroom leather swatch used for restoration" width={250} height={50} loading="lazy" /></a>,
  ...
  },
  {
    ...
    color: <a href="https://res.cloudinary.com/releather-com/image/upload/v1638909286/leather/PALETTE_espresso_HI.jpg" title="Espresso color leather sample used in dining chair reupholstery" target="_blank" rel="noopener noreferrer">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://res.cloudinary.com/releather-com/image/upload/c_crop,w_250,h_50/bo_2px_solid_rgb:f8991d/v1638909286/leather/PALETTE_espresso_HI.jpg" alt="Espresso brown leather swatch for high back dining chairs" title="Espresso brown leather swatch for high back dining chairs" width={250} height={50} loading="lazy" /></a>,
    leatherType: "Protected Leather",
  ...
  },
  {
    ...
    color: <a href="https://res.cloudinary.com/releather-com/image/upload/v1636920011/leather/SEDONA_pinto_HI.jpg" title="Sedona Pinto Leather Sample" target="_blank" rel="noopener noreferrer">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://res.cloudinary.com/releather-com/image/upload/c_crop,w_250,h_50/bo_2px_solid_rgb:f8991d/v1636920011/leather/SEDONA_pinto_HI.jpg" alt="Sedona pinto leather sample for reupholstery" title="Sedona pinto leather sample for reupholstery" width={250} height={50} loading="lazy" /></a>,
    leatherType: "Protected Leather",
  ...
  },
  {
    ...
    color: <a href="https://res.cloudinary.com/releather-com/image/upload/v1638909286/leather/PALETTE_harness-brown_HI.jpg" title="Palette Harness Brown Leather Sample" target="_blank" rel="noopener noreferrer">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://res.cloudinary.com/releather-com/image/upload/c_crop,w_250,h_50/bo_2px_solid_rgb:f8991d/v1638909286/leather/PALETTE_harness-brown_HI.jpg" alt="Palette harness brown leather sample for restoration" title="Palette harness brown leather sample for restoration" width={250} height={50} loading="lazy" /></a>,
    leatherType: "Protected Leather",
  ...
  },
  {
    ...
    serviceType: "Leather Recovering",
    furniture: "Wingback Chair",
    color: <a href="https://res.cloudinary.com/releather-com/image/upload/v1639529300/leather/Concerto_Mushroom_HI.jpg" title="Concerto Mushroom Leather Sample" target="_blank" rel="noopener noreferrer">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://res.cloudinary.com/releather-com/image/upload/c_crop,w_250,h_50/bo_2px_solid_rgb:f8991d/v1639529300/leather/Concerto_Mushroom_HI.jpg" alt="Concerto mushroom leather sample for chair recovering" title="Concerto mushroom leather sample for chair recovering" width={250} height={50} loading="lazy" /></a>,
  ...
  },
  {
    ...
    color: <a href="https://res.cloudinary.com/releather-com/image/upload/v1636920011/leather/SEDONA_pinto_HI.jpg" title="SEDONA Pinto Leather Swatch" target="_blank" rel="noopener noreferrer">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://res.cloudinary.com/releather-com/image/upload/c_crop,w_250,h_50/bo_2px_solid_rgb:f8991d//v1636920011/leather/SEDONA_pinto_HI.jpg" alt="SEDONA Pinto Leather Swatch" title="SEDONA Pinto Leather Swatch" width={250} height={50} loading="lazy" /></a>,
    leatherType: "Semi-Aniline Leather",
  ...
  },
  {
    ...
    color: <a href="https://res.cloudinary.com/releather-com/image/upload/v1638909286/leather/PALETTE_sandstone_HI.jpg" title="PALETTE Sandstone Leather Swatch" target="_blank" rel="noopener noreferrer">{/* eslint-disable-next-line @next/next/no-img-element */}<img src="https://res.cloudinary.com/releather-com/image/upload/c_crop,w_250,h_50/bo_2px_solid_rgb:f8991d//v1638909286/leather/PALETTE_sandstone_HI.jpg" alt="PALETTE Sandstone Leather Swatch" title="PALETTE Sandstone Leather Swatch" width={250} height={50} loading="lazy" /></a>,
    leatherType: "Protected Leather",
...
const processExtraMedia = (
  <figure className="border-4 border-black bg-white p-4">
    {/* eslint-disable-next-line @next/next/no-img-element */}
    <img
...
const faqItems = [
  {
    ...
    answer: (
      <>
        <p>The frequency of leather restoration depends on usage and wear. Typically, professional restoration every 5 to 7 years maintains appearance and durability. Regular care—like conditioning and cleaning—helps extend time between restorations.</p>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="https://res.cloudinary.com/releather-com/image/upload/c_scale,w_450,h_450/bo_10px_solid_rgb:f8991d/v1725867177/before-after/leather-restoration/furniture/blue/chair/leather-restoration-century-blue-leather-club-chair-nailhead-trim-faded-cushion.jpg" alt="leather restoration faded blue club chair" title="leather restoration faded blue club chair" width={450} height={450} loading="lazy" />
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        <p>We can resurface scratches and cracks during restoration. However, if the crack is too deep, it can&apos;t be fully repaired without compromising the leather&apos;s integrity. We assess the damage and tailor our service to restore the leather effectively and safely.</p>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="https://res.cloudinary.com/releather-com/image/upload/c_scale,w_450,h_450/bo_10px_solid_rgb:f8991d/v1715794039/samples/repairs/Restoration-Hardware-Leather-Sofa-Couch-Scratches-Scratch-200.jpg" alt="leather restoration for sofa with scratches" title="leather restoration for sofa with scratches" width={450} height={450} loading="lazy" />
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        <p>We may either carefully mask each nail head with tape to protect it or remove and replace them with new matching ones, depending on the condition and your preference. Our goal is to preserve the original look while restoring the leather.</p>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="https://res.cloudinary.com/releather-com/image/upload/c_scale,w_450,h_450/bo_10px_solid_rgb:f8991d/v1725867178/before-after/leather-restoration/furniture/blue/chair/leather-restoration-century-blue-leather-club-chair-nailhead-trim-faded-nailhead.jpg" alt="leather chair nailhead restoration process" title="leather chair nailhead restoration process" width={450} height={450} loading="lazy" />
      </>
    ),
  },
];
