      ...
      <main className="min-h-screen bg-white">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
          ...
          >
            ...
            <ul className="mt-6 grid list-none grid-cols-1 gap-6 p-0 sm:grid-cols-2 lg:grid-cols-4">
              {recommendationItems.map((item, index) => (
                <li key={index} className="flex flex-col items-center border-4 border-black p-4"><Image unoptimized
                    src={item.src}
                    alt={item.alt}
                    title={item.title}
                    width={200}
          ...
          >
            ...
            <figure className="mt-8 border-4 border-releather-orange p-2"><Image unoptimized
          ...
          <section className="mt-12 border-t-4 border-black pt-12">
            ...
            <dl className="mt-6 grid grid-cols-1 gap-2 font-sans text-gray-800 sm:grid-cols-2">
              ...
              <div className="border-b border-gray-300 py-2">
                ...
                <dd>
                  <a href="https://res.cloudinary.com/releather-com/image/upload/leather/Concerto_Dark-Brown_HI.jpg" title="Concerto Dark Brown Leather Sample" target="_blank" rel="noopener noreferrer"><Image unoptimized
          ...
          <section className="mt-12 border-t-4 border-black pt-12">
            ...
            <dl className="mt-6 grid grid-cols-1 gap-2 font-sans text-gray-800 sm:grid-cols-2">
              ...
              <div className="border-b border-gray-300 py-2">
                <dt className="font-bold text-black"><strong>Color:</strong></dt>
                <dd>
                  <a href="https://res.cloudinary.com/releather-com/image/upload/leather/Aniline_Mustard_HI.jpg" title="Aniline Mustard Leather Sample" target="_blank" rel="noopener noreferrer"><Image unoptimized
          ...
          <section className="mt-12 border-t-4 border-black pt-12">
            ...
            <dl className="mt-6 grid grid-cols-1 gap-2 font-sans text-gray-800 sm:grid-cols-2">
              ...
              <div className="border-b border-gray-300 py-2">
                <dt className="font-bold text-black"><strong>Color:</strong></dt>
                <dd>
                  <a href="https://res.cloudinary.com/releather-com/image/upload/leather/Concerto_Saddle_HI.jpg" title="View Concerto Saddle leather sample" target="_blank" rel="noopener noreferrer"><Image unoptimized
          ...
          <section className="mt-12 border-t-4 border-black pt-12">
            ...
            <dl className="mt-6 grid grid-cols-1 gap-2 font-sans text-gray-800 sm:grid-cols-2">
              ...
              <div className="border-b border-gray-300 py-2">
                <dt className="font-bold text-black"><strong>Color:</strong></dt>
                <dd>
                  <a href="https://res.cloudinary.com/releather-com/image/upload/leather/Concerto_Saddle_HI.jpg" title="Concerto Saddle Leather Sample" target="_blank" rel="noopener noreferrer"><Image unoptimized
