...
export const leatherUpholsteryIssuesIntro =
  "Leather Upholstery comes across a number of problems from wear and tear to pet damage. We highlight some of the common issues here.";

export const leatherUpholsteryIssuesItems = [
  {
    id: "Fix-Torn-Leather",
    title: "Fix Torn Leather!",
    body: (
      <p>
        We replace leather with tears, rips, or punctures. We reupholster with
        new leather.
      </p>
    ),
    media: (
  ...
  {
    id: "Fix-Ripped-Seams",
    title: "Fix Leather Ripped Seams!",
    body: (
      <p>
        We replace damaged leather and factory stitch new leather panels and
        sections.
      </p>
    ),
    media: (
  ...
  {
    id: "Fix-Oily-Stained",
    title: "Fix Oily Stained Leather!",
    body: (
      <p>
        We recover leather heavily stained with oil or grease. Reupholster new
        leather upholstery.
      </p>
    ),
    media: (
  ...
  {
    id: "Fix-Pet-Damage",
    title: "Fix Pet Damaged Leather!",
    body: (
      <p>
        We recover leather upholstery dog chewed or cat scratched with new
        leather.
      </p>
    ),
    media: (
  ...
  {
    id: "Fix-Faded-Leather",
    title: "Fix Faded Leather!",
    body: (
      <p>
        Sunlight fades and drys out leather. We replace dry and faded leather
        with new leather upholstery.
      </p>
    ),
    media: (
      <div className="flex justify-center"><Image unoptimized
  ...
  {
    id: "Fix-Cracked-Leather",
    title: "Fix Cracked Leather!",
    body: (
      <p>
        We replace cracking and cracked leather with new matching leather.
      </p>
    ),
    media: (
      <div className="flex justify-center"><Image unoptimized
  ...
  {
    id: "Replace-Bonded-Leather",
    title: "Replace Bonded Leather!",
    body: (
      <p>
        Replace imitation leather, bonded leather, vinyl, and other faux
        material with genuine Italian leather upholstery.
      </p>
    ),
    media: (
      <div className="flex justify-center"><Image unoptimized
  ...
  {
    id: "Replace-Fabric",
    title: "Replace Fabric Upholstery!",
    body: (
      <p>
        Makeover your furniture. Replace fabric upholstered furniture with
