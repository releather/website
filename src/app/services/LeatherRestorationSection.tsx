...
const leatherRestorationRecommended = [
  {
    name: "Pigmented",
    thumb:
...
type LeatherOption = (typeof leatherRestorationRecommended)[number];

export default function LeatherRestorationSection() {
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 max-w-3xl font-sans text-base leading-relaxed text-gray-700">
        This service addresses surface wear such as color fading, light
        scratches, scuffs, stains, and spotting. It also restores the
        leather&apos;s original uniform color and finish (
        <Link
          href="/services/leather-restoration#finishes"
          className="text-releather-orange hover:underline"
        >
          <em className="font-semibold text-black">
            matte, medium sheen, gloss
          </em>
        </Link>
        ). It enhances both appearance and longevity. We complete the process
        with a protective coating to prevent color transfer.
      </p>
        ...
        <div className="rounded-none border-4 border-gray-300 border-t-4 border-t-[#f8991d] bg-white p-5">
          ...
          <ul className="mt-4 space-y-4 font-sans text-sm text-gray-700">
            <li>
              ...
              <br /> 1-2 weeks. 1 day for vehicles.
            </li>
            <li>
        ...
        <div className="rounded-none border-4 border-gray-300 border-t-4 border-t-[#f8991d] bg-white p-5">
          ...
          <ul className="mt-4 space-y-4 font-sans text-sm text-gray-700">
            ...
            <li className="border-t border-gray-200 pt-4 aspect-video w-full overflow-hidden rounded-lg">
              <iframe
                src="https://www.youtube.com/embed/Po1Rx119hJA?rel=0&showinfo=0"
            ...
            <li className="border-t border-gray-200 pt-4">
              <a
                href="https://res.cloudinary.com/releather-com/image/upload/legal/warranty/Leather_Restoration_Service_Warranty.pdf"
                target="_blank"
                rel="noopener noreferrer"
...
<div className="mt-4 grid grid-cols-2 gap-3 sm:gap-4 lg:gap-4 lg:px-2">
          {leatherRestorationRecommended.map((leather) => (
              <button
                key={leather.name}
                type="button"
          ...
          <div className="mt-6 border-t border-gray-200 pt-6 grid grid-cols-3 gap-3">
            ...
            >
              ...
              <img
                ...
                alt="Automotive leather restoration"
                width={60}
                height={60}
                loading="lazy"
                className="h-12 w-12 object-contain"
            ...
            <Link
              ...
              title="Aviation leather restoration"
              className="flex flex-col items-center gap-1 text-center text-gray-700 transition hover:text-releather-orange"
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                ...
                alt="Aviation leather restoration"
                width={60}
                height={60}
                loading="lazy"
                className="h-12 w-12 object-contain"
